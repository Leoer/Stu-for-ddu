...
public class app_service {
    ...
    public static synchronized List<String[]> getWords() {
        		...
        		words.add(new String[] { "appserviceenvironment.net", "appserviceenvironment.cn" });
...
//              Azure Pipelines NOT AVAILABLE. 2022.1010 
                uselessFiles.add("deploy-azure-pipelines.md");
                return uselessFiles;
            }
...
//                    pending for release when it's available.
//                    uselessFiles.add("migration-alternatives.md");
//                    uselessFiles.add("how-to-custom-domain-suffix.md");
//                    uselessFiles.add("migrate.md");
//                    uselessFiles.add("overview.md");
//                    uselessFiles.add("overview-certificates.md");
...
//                   v3 not available. 2022-10-11
                    //  uselessFiles.add("configure-network-settings.md");
