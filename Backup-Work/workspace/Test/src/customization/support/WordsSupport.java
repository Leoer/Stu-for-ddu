...
public class WordsSupport {
	...
	public synchronized static void setWords() {
		...
		words.add(new String[] { "azurepowershell",   "azurepowershell" });
		words.add(new String[] { "Windows azure",   "Azure" });
		words.add(new String[] { "Windows Azure",   "Azure" });
		words.add(new String[] { "windows azure",   "azure" });
		
//		2022.11.08,replace China azure link to global azure link.
		words.add(new String[] { "https://docs.microsoft.com/",   "https://learn.microsoft.com/" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/",   "https://learn.microsoft.com/" });
		words.add(new String[] { "https://learn.microsoft.com/zh-cn/",   "https://learn.microsoft.com/" });
//		cli
		words.add(new String[] { "(/cli/",          "(https://learn.microsoft.com/cli/" });
//		words.add(new String[] { "(/cli",          "(https://learn.microsoft.com/cli/azure" });
//		words.add(new String[] { "(/cli//azure/",         "(https://learn.microsoft.com/cli/azure/" });
		words.add(new String[] { "https://docs.azure.cn/cli",   "https://learn.microsoft.com/cli/azure" });
		words.add(new String[] { "]: /cli",   "]: https://learn.microsoft.com/cli" });
		words.add(new String[] { "]: https://docs.azure.cn/cli",   "]: https://learn.microsoft.com/cli" });
		words.add(new String[] { ": /cli",   ": https://learn.microsoft.com/cli" });
		words.add(new String[] { "href=\"/cli",   "href=\"https://learn.microsoft.com/cli" });
		
		
//		developer
		words.add(new String[] { "https://docs.azure.cn/developer/",   "https://learn.microsoft.com/azure/developer/" });
		words.add(new String[] { "(/developer/",   "(https://learn.microsoft.com/azure/developer/" });
		words.add(new String[] { "(/azure/developer/",   "(https://learn.microsoft.com/azure/developer/" });
		words.add(new String[] { "]: /developer",   "]: https://learn.microsoft.com/azure/developer" });
//		python
//		words.add(new String[] { "https://docs.azure.cn/python/",   "https://learn.microsoft.com/azure/developer/python/" });
//		words.add(new String[] { "(/python/",   "(https://learn.microsoft.com/azure/developer/python/" });
//		words.add(new String[] { "(/azure/python/",   "(https://learn.microsoft.com/azure/developer/python/" });
		words.add(new String[] { "]: /python",   "]: https://learn.microsoft.com/azure/developer/python" });
		words.add(new String[] { "(/python/api",   "(https://learn.microsoft.com/python/api" });
		
//		dotnet
		words.add(new String[] { "https://docs.azure.cn/dotnet/",   "https://learn.microsoft.com/dotnet/" });
		words.add(new String[] { "(/dotnet/",   "(https://learn.microsoft.com/dotnet/" });
		words.add(new String[] { "(/azure/dotnet/",   "(https://learn.microsoft.com/dotnet/" });
		words.add(new String[] { "]: /dotnet",   "]: https://learn.microsoft.com/dotnet" });
		
//		javascript
		words.add(new String[] { "https://docs.azure.cn/developer/javascript/",   "https://learn.microsoft.com/azure/developer/javascript/" });
		words.add(new String[] { "(/developer/javascript/",   "(https://learn.microsoft.com/azure/developer/javascript/" });
		words.add(new String[] { "(/azure/developer/javascript/",   "(https://learn.microsoft.com/azure/developer/javascript/" });
		words.add(new String[] { "(/javascript/",   "(https://learn.microsoft.com/azure/developer/javascript/" });
		words.add(new String[] { "https://docs.azure.cn/javascript/",   "https://learn.microsoft.com/azure/developer/javascript/" });
		words.add(new String[] { "]: /developer/javascript",   "]: https://learn.microsoft.com/azure/developer/javascript" });
		
//		java
		words.add(new String[] { "https://docs.azure.cn/developer/java",   "https://learn.microsoft.com/azure/developer/java" });
		words.add(new String[] { "(/developer/java/",   "(https://learn.microsoft.com/azure/developer/java/" });
		words.add(new String[] { "(/java/api",   "(https://learn.microsoft.com/java/api" });
		words.add(new String[] { "(/azure/developer/java/",   "(https://learn.microsoft.com/azure/developer/java/" });
		words.add(new String[] { "]: /developer/java",   "]: https://learn.microsoft.com/azure/developer/java" });
		words.add(new String[] { "]: /java/api",   "]: https://learn.microsoft.com/java/api" });
		words.add(new String[] { "https://docs.azure.cn/java",   "https://learn.microsoft.com/azure/developer/java" });
		words.add(new String[] { "https://docs.azure.cn/java/api",   "https://learn.microsoft.com/java/api" });
		words.add(new String[] { "](/java/api",   "](https://learn.microsoft.com/java/api" });
		
//		go 
		words.add(new String[] { "https://docs.azure.cn/developer/go/",   "https://learn.microsoft.com/azure/developer/go/" });
		words.add(new String[] { "(/developer/go/",   "(https://learn.microsoft.com/azure/developer/go/" });
		words.add(new String[] { "(/azure/developer/go/",   "(https://learn.microsoft.com/azure/developer/go/" });
		words.add(new String[] { "]: /developer/go",   "]: https://learn.microsoft.com/azure/developer/go" });
		words.add(new String[] { "]: /go",   "]: https://learn.microsoft.com/azure/developer/go" });
		
//		rest api
		words.add(new String[] { "https://docs.azure.cn/rest/api/",   "https://learn.microsoft.com/rest/api/" });
		words.add(new String[] { "(/rest/api/",   "(https://learn.microsoft.com/rest/api/" });
		words.add(new String[] { "(/azure/rest/api/",   "(https://learn.microsoft.com/rest/api/" });
		words.add(new String[] { "]: /rest/api",   "]: https://learn.microsoft.com/azure/rest/api" });
		words.add(new String[] { "]: /azure/rest/api",   "]: https://learn.microsoft.com/azure/rest/api" });
		words.add(new String[] { "](/rest/api",   "](https://learn.microsoft.com/rest/api" });
		
//		powershell
		words.add(new String[] { "https://docs.azure.cn/powershell/",   "https://learn.microsoft.com/powershell/" });
//		words.add(new String[] { "(/powershell/",   "(https://learn.microsoft.com/powershell/" });
		words.add(new String[] { "(/azure/powershell/",   "(https://learn.microsoft.com/powershell/azure/" });
		words.add(new String[] { "]: /azure/powershell",   "]: https://learn.microsoft.com/powershell/azure" });
		words.add(new String[] { "]: /powershell",   "]: https://learn.microsoft.com/powershell" });
		words.add(new String[] { "(/powershell/azure",   "(https://learn.microsoft.com/powershell/azure" });
		
		words.add(new String[] { "(/nuget/",   "(https://learn.microsoft.com/nuget/" });
		words.add(new String[] { "]: /nuget",   "]: https://learn.microsoft.com/nuget" });
		
		words.add(new String[] { "(/training/",   "(https://learn.microsoft.com/training/" });
		words.add(new String[] { "]: /training",   "]: https://learn.microsoft.com/training" });
		
		words.add(new String[] { "(/learn/",   "(https://learn.microsoft.com/learn/" });
		words.add(new String[] { "]: /learn",   "]: https://learn.microsoft.com/learn" });
		
		words.add(new String[] { "(/visualstudio/",   "(https://learn.microsoft.com/visualstudio/" });
		words.add(new String[] { "]: /visualstudio",   "]: https://learn.microsoft.com/visualstudio" });
		
		words.add(new String[] { "(/developer/terraform/",   "https://learn.microsoft.com/azure/developer/terraform/" });
		words.add(new String[] { "]: /developer/terraform",   "]: https://learn.microsoft.com/developer/terraform" });
		
		words.add(new String[] { "(/terraform/",   "https://learn.microsoft.com/azure/developer/terraform/" });
		words.add(new String[] { "(/developer/terraform/",   "https://learn.microsoft.com/azure/developer/terraform/" });
		words.add(new String[] { "(/azure/developer/terraform/",   "https://learn.microsoft.com/azure/developer/terraform/" });
		words.add(new String[] { "]: /terraform",   "]: https://learn.microsoft.com/azure/developer/terraform" });
		words.add(new String[] { "]: /developer/terraform",   "]: https://learn.microsoft.com/azure/developer/terraform" });
		words.add(new String[] { "]: /azure/developer/terraform",   "]: https://learn.microsoft.com/azure/developer/terraform" });
		
		words.add(new String[] { "(/storage/",   "https://learn.microsoft.com/storage/" });
		words.add(new String[] { "]: /storage",   "]: https://learn.microsoft.com/storage" });
		
		words.add(new String[] { "(/sql/",   "https://learn.microsoft.com/sql/" });
		words.add(new String[] { "]: /sql",   "]: https://learn.microsoft.com/sql" });
		
		words.add(new String[] { "(/ef/",   "(https://learn.microsoft.com/ef/" });
		words.add(new String[] { "]: /ef",   "]: https://learn.microsoft.com/ef" });
		...
		words.add(new String[] { "Microsoft Azure",   "Azure" });
		words.add(new String[] { "microsoft azure",   "azure" });
		words.add(new String[] { "Microsoft Docs",   "Azure Docs" });
		
		words.add(new String[] { "testacr.azurecr.io",   "testacr.azurecr.cn" });
//		2022.6.24 add
		words.add(new String[] { "how-to-manage-ua-identity-portal.md",   "how-manage-user-assigned-managed-identities.md" });
...
//		words.add(new String[] { "active-directory/managed-identities-azure-resources/how-to-manage-ua-identity-portal.md",   "active-directory/managed-identities-azure-resources/how-manage-user-assigned-managed-identities.md" });
		words.add(new String[] { "/managed-identities-azure-resources/how-to-manage-ua-identity-portal.md",   "/managed-identities-azure-resources/how-manage-user-assigned-managed-identities.md" });
		...
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/powershell-install-configure",                  "/powershell-install-configure" });

		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/active-directory/develop/",                     "/active-directory/develop/" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/active-directory/connect/",                     "/active-directory/connect/" });

		words.add(new String[] { "https://learn.microsoft.com/azure/active-directory/develop/",                           "/active-directory/develop/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/active-directory/connect/",                           "/active-directory/connect/" });

		words.add(new String[] { "https://learn.microsoft.com/azure/site-recovery",                                       "/site-recovery" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/site-recovery",                                 "/site-recovery" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/active-directory/",                             "/active-directory/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/active-directory/",                                   "/active-directory/" });

		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/active-directory-domain-services",             "/active-directory-domain-services" });
		words.add(new String[] { "https://learn.microsoft.com/azure/active-directory-domain-services",                   "/active-directory-domain-services" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/bastion",                                      "/bastion" });
		words.add(new String[] { "https://learn.microsoft.com/azure/bastion",                                            "/bastion" });
			
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/documentdb/",                                   "/documentdb/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/documentdb/",                                         "/documentdb/" });

		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/backup/",                                       "/backup/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/backup/",                                             "/backup/" });

		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/automation",                                   "/automation" });
		words.add(new String[] { "https://learn.microsoft.com/azure/automation",                                         "/automation" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/batch/scripts/",                                "/batch/scripts/" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/batch/",                                        "/batch/" });

		words.add(new String[] { "https://learn.microsoft.com/azure/batch/scripts/",                                      "/batch/scripts/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/batch/",                                              "/batch/" });

		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/key-vault/",                                    "/key-vault/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/key-vault/",                                          "/key-vault/" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/private-link/",                                 "/private-link/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/private-link/",                                       "/private-link/" });

		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/multi-factor-authentication/end-user/",         "/multi-factor-authentication/end-user/" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/multi-factor-authentication/",                  "/multi-factor-authentication/" });

		words.add(new String[] { "https://learn.microsoft.com/azure/multi-factor-authentication/end-user/",               "/multi-factor-authentication/end-user/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/multi-factor-authentication/",                        "/multi-factor-authentication/" });

		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/notification-hubs/",   "/notification-hubs/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/notification-hubs/",         "/notification-hubs/" });

		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/power-bi-embedded/",   "/power-bi-embedded/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/power-bi-embedded/",         "/power-bi-embedded/" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/azure-functions/",      "/azure-functions/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/azure-functions/",            "/azure-functions/" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/app-service/",          "/app-service/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/app-service/",                "/app-service/" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/application-gateway",                 "/application-gateway" });
		words.add(new String[] { "https://learn.microsoft.com/azure/application-gateway",                       "/application-gateway" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/storage/",                            "/storage/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/storage/",                                  "/storage/" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/cosmos-db/",                          "/cosmos-db/" });
		words.add(new String[] { "https://learn.microsoft.com/azure/cosmos-db/",                                "/cosmos-db/" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/cognitive-services",                  "/cognitive-services" });
		words.add(new String[] { "https://learn.microsoft.com/azure/cognitive-services",                        "/cognitive-services" });
		
		words.add(new String[] { "https://azure.microsoft.com/services/functions",                             "https://www.azure.cn/zh-cn/home/features/azure-functions" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/monitoring-and-diagnostics",          "/monitoring-and-diagnostics" });
		words.add(new String[] { "https://learn.microsoft.com/azure/monitoring-and-diagnostics",                "/monitoring-and-diagnostics" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/virtual-network",                     "/virtual-network" });
		words.add(new String[] { "https://learn.microsoft.com/azure/virtual-network",                           "/virtual-network" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/app-service-web",                     "/app-service-web" });
		words.add(new String[] { "https://learn.microsoft.com/azure/app-service-web",                           "/app-service-web" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/active-directory-b2c",                "/active-directory-b2c" });
		words.add(new String[] { "https://learn.microsoft.com/azure/active-directory-b2c",                      "/active-directory-b2c" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/governance",                           "/governance" });
		words.add(new String[] { "https://learn.microsoft.com/azure/governance",                                 "/governance" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/event-hubs",                           "/event-hubs" });
		words.add(new String[] { "https://learn.microsoft.com/azure/event-hubs",                                 "/event-hubs" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/azure-monitor",                        "/azure-monitor" });
		words.add(new String[] { "https://learn.microsoft.com/azure/azure-monitor",                              "/azure-monitor" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/sql-database",                        "/sql-database" });
		words.add(new String[] { "https://learn.microsoft.com/azure/sql-database",                              "/sql-database" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/service-bus-messaging",               "/service-bus-messaging" });
		words.add(new String[] { "https://learn.microsoft.com/azure/service-bus-messaging",                     "/service-bus-messaging" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/dns",                                "/dns" });
		words.add(new String[] { "https://learn.microsoft.com/azure/dns",                                      "/dns" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-gb/azure/azure-stack",                        "/azure-stack" });
		words.add(new String[] { "https://learn.microsoft.com/azure/security/",                                "/security/" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/virtual-machine-scale-sets",         "/virtual-machine-scale-sets" });
		words.add(new String[] { "https://learn.microsoft.com/azure/azure-stack",                        "/azure-stack" });
		words.add(new String[] { "https://learn.microsoft.com/azure/vpn-gateway",                        "/vpn-gateway" });
		words.add(new String[] { "https://learn.microsoft.com/azure/virtual-machines",                   "/virtual-machines" });
		
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/virtual-machine-scale-sets",   "/virtual-machine-scale-sets" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/azure-stack",                  "/azure-stack" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/vpn-gateway",                  "/vpn-gateway" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/virtual-machines",             "/virtual-machines" });
		
		words.add(new String[] { "https://learn.microsoft.com/role-based-access-control",                "/role-based-access-control" });
		words.add(new String[] { "https://learn.microsoft.com/azure/role-based-access-control",          "/role-based-access-control" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/role-based-access-control",    "/role-based-access-control" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/azure-resource-manager",             "/azure-resource-manager" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/azure-resource-manager",       "/azure-resource-manager" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/service-fabric",                     "/service-fabric" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/service-fabric",               "/service-fabric" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/azure-cache-for-redis",              "/azure-cache-for-redis" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/azure-cache-for-redis",        "/azure-cache-for-redis" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/event-grid",                         "/event-grid" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/event-grid",                   "/event-grid" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/aks",                                "/aks" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/aks",                          "/aks" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/cloud-services",                    "/cloud-services" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/cloud-services",              "/cloud-services" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/service-health",                    "/service-health" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/service-health",              "/service-health" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/time-series-insights",              "/time-series-insights" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/time-series-insights",        "/time-series-insights" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/iot-hub",                           "/iot-hub" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/iot-hub",                     "/iot-hub" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/logic-apps",                           "/logic-apps" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/logic-apps",                     "/logic-apps" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/stream-analytics",                    "/stream-analytics" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/stream-analytics",              "/stream-analytics" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/api-management",                      "/api-management" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/api-management",                "/api-management" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/web-application-firewall",            "/web-application-firewall" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/web-application-firewall",      "/web-application-firewall" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/load-balancer",                       "/load-balancer" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/load-balancer",                 "/load-balancer" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/security-center",                       "/security-center" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/security-center",                 "/security-center" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/network-watcher",                       "/network-watcher" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/network-watcher",                 "/network-watcher" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/firewall",                              "/firewall" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/firewall",                        "/firewall" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/media-services",                        "/media-services" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/media-services",                  "/media-services" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/log-analytics",                        "/log-analytics" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/log-analytics",                  "/log-analytics" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/machine-learning",                        "/machine-learning" });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/machine-learning",                  "/machine-learning" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/spring-cloud",                            "/spring-cloud"  });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/spring-cloud",                      "/spring-cloud" });
		
		words.add(new String[] { "https://learn.microsoft.com/azure/search",                                "/search"  });
		words.add(new String[] { "https://learn.microsoft.com/en-us/azure/search",                          "/search" });
...
//		words.add(new String[] { "/rest/api/",                                             "https://docs.microsoft.com/rest/api/" });
		...
		words.add(new String[] { "https://learn.microsoft.com/powershell/azure/install-azurerm-ps",   "https://learn.microsoft.com/en-us/powershell/azure/install-az-ps?view=azps-1.2.0" });
...
//		words.add(new String[] { "](/azure/storage",                      "](/storage" });
		...
		words.add(new String[] { "](/azure/event-grid",                   "](/event-grid" });
		words.add(new String[] { "](/azure/iot-hub",              "](/iot-hub" });
		words.add(new String[] { "](/azure/machine-learning",              "](/machine-learning" });
		words.add(new String[] { "](/azure/cosmos-db",              "](/cosmos-db" });
		words.add(new String[] { "](/azure/route-server",              "](/route-server" });
		...
		words.add(new String[] { "](/graph",                             "](https://learn.microsoft.com/graph" });
		words.add(new String[] { "](/intune",                            "](https://learn.microsoft.com/intune" });
		words.add(new String[] { "](/dotnet/api",                        "](https://learn.microsoft.com/dotnet/api" });
		words.add(new String[] { "](/windows-server",                    "](https://learn.microsoft.com/windows-server" });
		words.add(new String[] { "](/aspnet/",                           "](https://learn.microsoft.com/aspnet/" });
		words.add(new String[] { "](/xamarin",                           "](https://learn.microsoft.com/xamarin" });
		words.add(new String[] { "](/previous-versions/",                "](https://learn.microsoft.com/previous-versions/" });
		words.add(new String[] { "](/sharepoint/",                       "](https://learn.microsoft.com/sharepoint/" });
		words.add(new String[] { "](/office365/",                        "](https://learn.microsoft.com/office365/" });
		words.add(new String[] { "](/mem/",                              "](https://learn.microsoft.com/mem/" });
		words.add(new String[] { "](/microsoft-identity-manager/",       "](https://learn.microsoft.com/microsoft-identity-manager/" });
		words.add(new String[] { "](/Exchange",                          "](https://learn.microsoft.com/Exchange" });
		words.add(new String[] { "](/skypeforbusiness",                  "](https://learn.microsoft.com/skypeforbusiness" });
		words.add(new String[] { "](/archive/",                          "](https://learn.microsoft.com/archive/" });
		words.add(new String[] { "](/answers",                           "](https://learn.microsoft.com/answers" });
		words.add(new String[] { "](/windows/",                          "](https://learn.microsoft.com/windows/" });
		words.add(new String[] { "](/microsoft-365/",                    "](https://learn.microsoft.com/microsoft-365/" });
		words.add(new String[] { "](/sql/",                              "](https://learn.microsoft.com/sql/" });
		words.add(new String[] { "](/powershell/",                       "](https://learn.microsoft.com/powershell/" });
		words.add(new String[] { "](/dynamics365",                       "](https://learn.microsoft.com/dynamics365" });
		words.add(new String[] { "](/power-bi/",                         "](https://learn.microsoft.com/power-bi/" });
		words.add(new String[] { "](/exchange/",                         "](https://learn.microsoft.com/exchange/" });
		words.add(new String[] { "](/iis",                               "](https://learn.microsoft.com/iis" });
		words.add(new String[] { "](/configmgr",                         "](https://learn.microsoft.com/configmgr" });
		words.add(new String[] { "](/windows-hardware",                  "](https://learn.microsoft.com/windows-hardware" });
		words.add(new String[] { "](/universal-print",                   "](https://learn.microsoft.com/universal-print" });
		words.add(new String[] { "](/home",                              "](https://learn.microsoft.com/home" });
		words.add(new String[] { "](/python/api",                        "](https://learn.microsoft.com/python/api" });
		words.add(new String[] { "](/samples",                           "](https://learn.microsoft.com/samples" });
		words.add(new String[] { "](/azure/templates",                   "](https://learn.microsoft.com/azure/templates" });
		words.add(new String[] { "](/visualstudio/azure",                "](https://learn.microsoft.com/visualstudio/azure" });
		words.add(new String[] { "](/security-updates",                  "](https://learn.microsoft.com/security-updates" });
