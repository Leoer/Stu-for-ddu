...
public class WarningWordsSupport {
	...
	public synchronized static void setWarningWords() {		
		...
		warningWords.add("d1b33a60-333f-4d6e-9ade-17a7020562a9");
...
//	    warningWords.add("az login");
	    ...
	    warningWords.add("chinaeast22");
	    warningWords.add("chinaeast222");
	    warningWords.add("chinanorth22");
	    warningWords.add("chinanorth222");
	    warningWords.add("chinaeast33");
	    warningWords.add("chinaeast333");
	    warningWords.add("chinanorth33");
	    warningWords.add("chinanorth333");
